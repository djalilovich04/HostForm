...
function HostForm() {
  ...
  return (
    ...
    <div className='first_step'>
      ...
      <p>In this step,
       ...
       guests will book the entire place or just a room.
        ...
        <p style={{marginLeft:'150px',fontSize:'18px',color:'black',marginTop:'-20px',fontWeight:'bold'}}>
        Paste your location link here:</p>
          <div>
          <input style={{backgroundColor: 'white', padding: '0.5rem',width:'250px',
        textAlign:'center', margin: '0 0.5rem',borderRadius:'8px',color:'black',marginLeft:'400px'}}
        type="text"
        id="location"
        name="location"
      ...
      />
        ...
        <label>
          <p style={{marginLeft:'-30px',fontSize:'18px',color:'black'}}>Max Guests:</p>
        ...
        textAlign:'center', margin: '0 0.5rem',borderRadius:'8px' }}>{numGuests}</span>
        ...
        <p style={{marginLeft:'50px',fontSize:'18px',color:'black',marginTop:'-20px'}}>
        In this step, you'll add some of the amenities your place offers, some pictures.<br /> Then, 
        you'll create a title and description.</p>
        </div>
        <br />
        <h2 style={{margin:'-10px',marginLeft: '50px'}}>What your place has to offer ?</h2>
        <br />
        <br />
    ...
    style={{ display: 'inline-block',marginLeft:'430px', padding: '10px',
     color: 'black', textDecoration: 'underline',
      borderRadius: '5px' }}>Upload images from your device.</a>
      <input
        type="file"
        ref={fileInputRef}
      ...
      {selectedFiles.map((file, index) => (
          <div className='index' key={index}>
            ...
            />
            <p style={{marginLeft:'-30px',fontSize:'15px',color:'black',fontWeight:'1000'}}>{file.name}</p> 
          </div>
        ))}
    </div>
    <br />
    <h2>Now, let's give your house a title.</h2>
    <p style={{marginLeft:'50px',fontSize:'18px',color:'gray',marginTop:'-20px'}}>
    Short titles work best. Have fun with it—you can always change it later.</p>
      <textarea rows={5} style={{marginLeft:'100px',height:'150px'}}></textarea>
      <h2>Create your description.</h2>
    <p style={{marginLeft:'50px',fontSize:'18px',color:'gray',marginTop:'-20px'}}>
    Share what makes your place special..</p>
    <textarea className='text2' rows={5} style={{marginLeft:'100px',height:'250px'}}></textarea>
    <br />
    <div className='second_step'>
        <h2>Third step: Finish up and publish.</h2>
        <p style={{marginLeft:'50px',fontSize:'18px',color:'black',marginTop:'-20px'}}>
        Finally, you'll set up pricing, choose payment methods, and publish <br /> your listing.</p>
        </div>
        <br />
    ...
    <input
        ...
        placeholder='3000'
      />
      <span style={{fontSize:'70px',marginTop:'50px',color:'black'}}>DZD</span>
      </div>
      <h2>Now, choose your payment method.</h2>
    <p style={{marginLeft:'50px',fontSize:'18px',color:'gray',marginTop:'-20px'}}>
    Here, you can choose how your customers make their payment.</p>
    <br />
    <div className='paymentMeth'>
        <button
          type="button"
          onClick={() => handlePaymentMethod('paypal')}
          className={paymentMethod === 'paypal' ? 'payment-button active' : 'payment-button'}
        >
         <p style={{fontSize:'18px',color:'black',marginTop:'22px'}}>CCP Transfer</p>
         <img src={virement1} />
        </button>
        <br />
        <br />
        <button
          ...
          className={paymentMethod === 'credit_card' ? 'payment-button active' : 'payment-button'}
        >
         <p style={{fontSize:'18px',color:'black',marginTop:'22px'}}> Credit Card (BaridiMob)</p>
         <img src={carte1} />       
        </button>
      </div>
      <br />
      <div className='submitbtn'>
      <button type="submit"><p style={{fontSize:'25px',color:'white',marginTop:'0px',marginLeft:'60px'}}>
       Publish</p></button>
       </div>
      </form>
    </div>
